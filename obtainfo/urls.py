...
urlpatterns = patterns('obtainfo.views',
	# server
	...
	url(ur'^index/(?P<query>(?!_)(?!-)(?!.*?_/$)(?!.*?-/$)[\-a-zA-Z0-9_\u4e00-\u9fa5]+)/$', 'views.index'),
...
urlpatterns += patterns('obtainfo.admin.common',
	# login logout
...
urlpatterns += patterns('obtainfo.admin.server',
	# common
