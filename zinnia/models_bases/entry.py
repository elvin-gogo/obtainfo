...
class CoreEntry(models.Model):
    ...
    slug = models.SlugField(
        ...
        default=lambda: str(int(time.time()*1000) % 1000000) + str(random.randint(100, 999)),
...
class ImageEntry(models.Model):
    ...
    image = models.ImageField(
        _('image'), blank=False, upload_to=UPLOAD_TO,
